...
def test_risk_calculation_service_calculate_risk_with_transactions_zero_case():
...
def test_risk_calculation_service_calculate_risk_with_transactions_good_case():
    risk_calculation_service = RiskCalculationService()
    tuple_transactions = [
...
def test_risk_calculation_service_calculate_risk_with_transactions_bad_case():
    risk_calculation_service = RiskCalculationService()
...
def test_risk_calculation_service_calculate_risk_with_transactions_very_bad_case():
    risk_calculation_service = RiskCalculationService()
    tuple_transactions = [
        # date, amount, type, description, category, merchant, balance, nsf
...
def test_risk_calculation_service_calculate_risk_with_transactions_worst_case():
    risk_calculation_service = RiskCalculationService()
    tuple_transactions = [
        # date, amount, type, description, category, merchant, balance, nsf
