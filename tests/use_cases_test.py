...
class TestUseCases:
    @pytest.fixture
    def mock_decision_repo_no_transactions(self, mocker):
    ...
    @pytest.fixture
    def mock_decision_repo_with_transactions_higher(self, mocker):
        """Fixture to create a mock of the repository using pytest-mock"""
        mock_repo = mocker.AsyncMock(spec=TransactionRepository) 
        mock_repo.get_user_transactions.return_value = [
            Transaction(
    ...
    @pytest.fixture
    def mock_decision_repo_with_transactions_middle(self, mocker):
        """Fixture to create a mock of the repository using pytest-mock"""
        mock_repo = mocker.AsyncMock(spec=TransactionRepository) 
        mock_repo.get_user_transactions.return_value = [
            Transaction(
    ...
    @pytest.fixture
    def mock_decision_repo_with_transactions_lower(self, mocker):
        """Fixture to create a mock of the repository using pytest-mock"""
        mock_repo = mocker.AsyncMock(spec=TransactionRepository)
        mock_repo.get_user_transactions.return_value = [
            Transaction(
    ...
    @pytest.mark.asyncio
    async def test_validate_decision_high_risk(self, mock_decision_repo_no_transactions):
    ...
    @pytest.mark.asyncio
    async def test_validate_decision_with_plan_approved_higher_score(self, mock_decision_repo_with_transactions_higher):
    ...
    @pytest.mark.asyncio
    async def test_validate_decision_with_plan_approved_middle_score(self, mock_decision_repo_with_transactions_middle):
        """Test for approved decision with plan"""
